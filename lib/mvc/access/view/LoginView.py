...
class LoginView(AccessView):
    ...
    def __init__(self, parent_widget: QWidget = None):
        ...
        self.emailLayout = LineEditLayout(FormStrings.EMAIL, parent_widget=self, default="azienda1@mail.com")

        # Campo di input Password
        self.passwordLayout = LineEditLayout(FormStrings.PASSWORD, parent_widget=self, default="password1234")
