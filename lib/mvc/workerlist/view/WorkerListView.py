...
from PyQt5.QtWidgets import (
    QTableWidget,
    QTableWidgetItem, QWidget, QHeaderView, QAbstractItemView, QStyledItemDelegate, QFrame, QPushButton
)
...
from lib.mvc.workerlist.view.AddWorkerWindow import AddWorkerWindow
from lib.mvc.workerlist.view.EditWorkerWindow import EditWorkerWindow
