...
class OrderFormView(QDialog, ABC, metaclass=OrderFormViewMeta):
    def __init__(self):
        ...
        self.gender_combo_box.insertItem(0, "Uomo", userData=Gender.UOMO)
        self.gender_combo_box.insertItem(1, "Donna", userData=Gender.DONNA)
        self.gender_combo_box.insertItem(2, "Bambino", userData=Gender.BAMBINO)
        ...
        self.type_combo_box.insertItem(0, "Bassa", userData=ShoeLastType.BASSA)
        self.type_combo_box.insertItem(1, "Polacco", userData=ShoeLastType.POLACCO)
        self.type_combo_box.setCurrentIndex(0)
        self.plastic_label.setText("Seleziona tipo/qualità plastica:")
        self.plastic_combo_box.insertItem(0, "Tipo 1 - Discreta", userData=PlasticType.TIPO_1_DISCRETA)
        self.plastic_combo_box.insertItem(1, "Tipo 2 - Buona", userData=PlasticType.TIPO_2_BUONA)
        self.plastic_combo_box.insertItem(2, "Tipo 3 - Ottima", userData=PlasticType.TIPO_3_OTTIMA)
        self.plastic_combo_box.setCurrentIndex(0)
        self.first_compass_label.setText("Seleziona prima bussola:")
        self.first_compass_combo_box.insertItem(0, "Standard", userData=CompassType.STANDARD)
        self.first_compass_combo_box.insertItem(1, "Rinforzata", userData=CompassType.RINFORZATA)
        self.first_compass_combo_box.setCurrentIndex(0)
        self.second_compass_label.setText("Seleziona seconda bussola:")
        self.second_compass_combo_box.insertItem(0, "Nessuna", userData=CompassType.NESSUNA)
        self.second_compass_combo_box.insertItem(1, "Standard", userData=CompassType.STANDARD)
        self.second_compass_combo_box.insertItem(2, "Rinforzata", userData=CompassType.RINFORZATA)
        self.second_compass_combo_box.setCurrentIndex(0)
        self.processing_label.setText("Seleziona lavorazione:")
        self.processing_combo_box.insertItem(0, "Nessuna (forma intera)", userData=Processing.NESSUNA)
        self.processing_combo_box.insertItem(1, "Cuneo", userData=Processing.CUNEO)
        self.processing_combo_box.insertItem(2, "Snodo alfa", userData=Processing.SNODO_ALFA)
        self.processing_combo_box.insertItem(3, "Snodo tendo", userData=Processing.SNODO_TENDO)
        self.processing_combo_box.setCurrentIndex(0)
        self.shoeing_label.setText("Seleziona ferratura:")
        self.shoeing_combo_box.insertItem(0, "Nessuna (forma liscia)", userData=Shoeing.NESSUNA)
        self.shoeing_combo_box.insertItem(1, "Tacco ferrato", userData=Shoeing.TACCO_FERRATO)
        self.shoeing_combo_box.insertItem(2, "Mezza ferrata", userData=Shoeing.MEZZA_FERRATA)
        self.shoeing_combo_box.insertItem(3, "Tutta ferrata", userData=Shoeing.TUTTA_FERRATA)
